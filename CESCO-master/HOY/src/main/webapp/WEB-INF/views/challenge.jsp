...
<body>.
    ...
    <div>    
        <div class="container" id="challenge">
            <img id="chal_img" src="resources/img/hoy6.svg" class="main_img">
            <div>
            <% MemberVO vo = (MemberVO) session.getAttribute("mb_vo");%>
            <%if (vo != null) {%>
            <span><%=vo.getMb_nickname() %> 님 환영합니다 !</span>
            <%} %>
            ...
            <div class="text_box">
            <%if (vo != null) {%>
                <p><%=vo.getMb_point() %> Point</p>
                <%} %>
            </div>
            <ul class="chal_category">
                <li><div><a href="ch_kind.do?kind=exercise"><img src="resources/img/category_exercise.svg"></a></div></li>
                <li><div><a href="ch_kind.do?kind=self"><img src="resources/img/category_self.svg"></a></div></li>
                <li><div><a href="ch_kind.do?kind=everyday"><img src="resources/img/category_everyday.svg"></a></div></li>
                <li><div><a href="ch_ing_list.do"><img src="resources/img/category_ing.svg"></a></div></li>
            </ul>
    </div>
    </div>
